...
Простая утилита для передачи файлов по TCP с использованием standalone Asio (header-only библиотека).
...
- **Standalone Asio** (header-only) - асинхронный ввод-вывод и сетевое взаимодействие
- **spdlog** - быстрое логирование
- **Google Test** - модульное тестирование
- **ws2_32** - Windows Sockets для сетевых операций
